      ...
      <section className="max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="w-full lg:w-1/2 space-y-4 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-gray-900">Personalized Guidance, Tailored to You</h2>
            <p className="text-gray-700">
              Whether you're looking for expert advice, career direction, emotional support, or personal growth,
              our 1-on-1 consultations are designed to give you the focused attention you deserve.
            </p>
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <Image src="/placeholder.svg" alt="Guidance Session" width={500} height={300} className="rounded-lg shadow-md object-cover" />
          </div>
        </div>

        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="w-full lg:w-1/2 flex justify-center">
            <Image src="/placeholder.svg" alt="What You Can Expect" width={500} height={300} className="rounded-lg shadow-md object-cover" />
          </div>
          <div className="w-full lg:w-1/2 space-y-4 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-gray-900">What You Can Expect</h2>
            <p className="text-gray-700">
              Whether you're looking for expert advice, career direction, emotional support, or personal growth,
              our 1-on-1 consultations are designed to give you the focused attention you deserve.
            </p>
